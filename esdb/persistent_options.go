...
// PersistentStreamSubscriptionOptions options of the most persistent subscription requests.
...
// PersistentAllSubscriptionOptions options of the most persistent subscription requests.
